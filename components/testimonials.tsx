...
const testimonials = [
    {
        name: 'Jane Cooper',
        quote: 'I am so happy with the service I received from this company. I will definitely be recommending them to my friends and family.',
    },
    {
        name: 'Lisa Marie',
        quote: 'I am so happy with the service I received from this company. I will definitely be recommending them to my friends and family.',
...
const Testimonials = () => {
  return (
    <section className="bg-white  m-4 lg:mx-[180px] my-8">
